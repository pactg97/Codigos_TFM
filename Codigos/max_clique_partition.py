# -*- coding: utf-8 -*-
"""
Created on Thu Dec 10 16:00:21 2020
...
def max_clique_partition(G):
    try:
        ...
        m.setObjective(sum([sum([x[i][j] for j in range(i)]) for i in range(n)]), GRB.MAXIMIZE)
...
c1=max_clique_partition(G4)
c2=max_clique_partition(H)
print(c1)
print(c2)